...
|--------------------------|------------------|------------------|---------------------------|
| Программмирование на Go  | Stepik           | Июнь 2022     | [Сертификат](https://stepik.org/cert/2506601) |
| Регулярные выражения в Python           | Stepik              | Февраль 2023     | [Сертификат](https://stepik.org/cert/2428597) |
